...
class S implements WidgetsLocalizations {
  ...
  String get all_absences => "Absence (excluding delay): {amount} hours";

  String get all_average => "Total average: ";

  String get all_delay => "Total delay: {amount} minutes";
  ...
  String get delete_confirmation => "Would you like to delete user: {name} ?";
  ...
  String get parental_justification => "Parental justification: {amount}";
  ...
  String get sync_frequency => "Frequency of sync: {mins} min";
...
class $hu extends S {
  ...
  @override
  String get parental_justification => "Szülői igazolás: {{ amount }} db";

  @override
  String get two_months => "két hónap";

  @override
  String get lessons => "órák: {{ db }} db";
  ...
  @override
  String get all_delay => "Összes késés: {{ amount }} perc";
  ...
  @override
  String get sync_frequency => "Szinkronizálás gyakorisága: {{ mins }} perc";
